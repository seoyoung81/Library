...
<figure><img src="../../.gitbook/assets/image (4) (1) (1).png" alt="" width="254"><figcaption><p>num 변수의 타입을 number라고 지정하지 않았지만, 10이라는 값을 보고 타입을 알아낸다.</p></figcaption></figure>

2.  함수의 타입 추론

    <figure><img src="../../.gitbook/assets/image (5) (1) (1).png" alt="" width="375"><figcaption><p>함수의 반환 타입을 number로 추론하였다.</p></figcaption></figure>

추론된 함수의 반환 타입이 기대한 것과 다르다면 타입 선언을 직접 명시하고, 실제 문제가 발생하는 부분을 찾아 봐야 한다.&#x20;



<figure><img src="../../.gitbook/assets/image (6) (1) (1).png" alt="" width="354"><figcaption><p>조건문 외부에서 message 타입은 string | null이지만 내부에서는 string이다.</p></figcaption></figure>
